...
<head>
  ...
  <title>ShopEasy | Client - @yield('title')</title>
  ...
  <style>
    ...
    .admin-sidebar.compact .nav-link-client {
...
<body>
  ...
  <aside id="adminSidebar" class="admin-sidebar" role="navigation" aria-label="Barre latérale principale">
    ...
    <nav class="mt-2 d-flex flex-column" aria-label="Menu principal">
        ...
        <a href="{{ route('client.dashboard') }}" class="{{ request()->routeIs('client.dashboard') ? 'active' : '' }} nav-link-client">
        ...
        <a href="{{ route('logout') }}" class="nav-link-client"
