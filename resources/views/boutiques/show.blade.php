...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-md-9">
            <h2 class="fw-bold">{{ $boutique->nom }}</h2>
            <h5 class="">{{ $boutique->description }}</h5>
        </div>
    </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <form method="GET">
                                ...
                                @foreach ($category->sousCategories as $sous)
                                    <div class="form-check ms-2">
                                        <input class="form-check-input"
                                               ...
                                               name="categorie"
                                               value="{{ $category->slug }}"
                                               {{ request('categorie') == $category->slug ? 'checked' : '' }}>
                        ...
                        <button class="btn btn-dark text-warning fw-bold btn-sm w-100 mt-3">
                            Appliquer
                        </button>
                      ...
                      <div class="col-md-3 col-sm-6 mix {{ $bien->categorie }} animate__animated animate__fadeIn bien-grid" data-title="{{ strtolower($bien->titre) }}">
                          <div class="card shadow-sm border-0 rounded-4">
                              ...
                              <div class="card-body">
                                ...
                                <h5 class="card-title text-dark mb-2">{{ $bien->titre }}</h5>
                            
                                <!-- Catégorie -->
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    <i class="bi bi-tags-fill text-dark"></i>
                                    <span>
                                        Catégorie :
                                        <span class="badge bg-dark text-warning fw-semibold">
                                            {{ ucfirst($bien->categorie?->name ?? '-') }}
                                        </span>
                                    </span>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <span class="fw-semibold">
                                        Stock :
                                        @if ($bien->stock >= 5)
                                            <span class="text-success">{{ $bien->stock }} disponibles</span>
                                        @elseif ($bien->stock <= 1)
                                            <span class="text-danger">{{ $bien->stock }} disponible</span>
                                        @else
                                            <span class="text-warning">{{ $bien->stock }} disponibles</span>
                                        @endif
                                    </span>
                                </div>
                                ...
                                <div class="mt-auto d-flex justify-content-between gap-1">
                                    ...
                                    <button class="btn btn-outline-info btn-sm flex-fill"
                                            data-bs-toggle="modal"
                                            data-bs-target="#bienModal{{ $bien->id }}">
